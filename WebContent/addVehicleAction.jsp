...
<!-- Action to add vehicle to the vehicle XML. If the vehicle has already been registered, returns error for already registered-->
...
<body>
	...
	<%
		...
		vehicle.setKilometres(Double.parseDouble(request
		...
		<div class="row vertical-center-row">
			...
			<div class="col-lg-6">
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						The vehicle
						<%=request.getParameter("regoNumber")%>
						already exists. Please try registering with a different vehicle.
					</div>
					<div class="panel-footer text-center">
